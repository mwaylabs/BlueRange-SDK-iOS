...
@implementation BRRelutionHeatmapSenderStub
...
- /* override */ (void) sendReport: (id<BRBeaconMessageReport>) report {
    ...
    NSString* reportString = [BRJsonUtils jsonStringForDictionary:jsonReport];
    NSLog(@"Sending report: %@", reportString);
}
