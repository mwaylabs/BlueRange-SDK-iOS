...
#import "BRRelutionTagInfos.h"

@class BRHttpClient;

// Exception classes
@interface BRRelutionException : NSException
@end
@interface BRLoginException : NSException
@end

@interface BRRelution : NSObject {
    BRHttpClient* _httpClient;
}

@property (readonly) NSString* baseUrl;
@property (readonly) NSString* username;
@property (readonly) NSString* password;
@property (readonly) NSString* organizationUuid;
