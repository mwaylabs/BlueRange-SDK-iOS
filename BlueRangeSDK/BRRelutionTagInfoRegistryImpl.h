//
//  BRRelutionTagInfoRegistryImpl.h
//  BlueRangeSDK
//
...
/**
 * This class is the default implementation for the {@link BRRelutionTagInfoRegistry} interface.
 */
@interface BRRelutionTagInfoRegistryImpl : NSObject<BRRelutionTagInfoRegistry> {
    // Logging
    ...
    NSMutableDictionary* _tagToInfo;
}
