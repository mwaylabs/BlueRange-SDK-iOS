...
/**
 * The beacon message generator is used to filter and generate {@link BRBeaconMessage} objects out
 * of {@link Beacon} objects.
 */
@protocol BRBeaconMessageGenerator
